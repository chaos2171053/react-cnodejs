import { REQUEST_ARTICLE, RECEIVE_ARTICLE, CHANGE_CURRENT_TOPICID, SWITCH_SUPPORT, FETCH_COMMENT, RECORD_ARTICLE_SCROLLT } from '../actions/actions'
...
const article = (state = { currentTopicId: '' }, action) => {
    ...
    switch (action.type) {
        ...
        case REQUEST_ARTICLE:
            ...
            return {
                ...state,
                [aciton.topicId]: stateItem,
                currentTopicId: acion.topicId,
                isCommented: false
            }
